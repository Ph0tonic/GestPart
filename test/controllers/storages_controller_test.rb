...
class StoragesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create storage" do
    assert_difference('Storage.count') do
      post storages_url, params: { storage: { memo: @storage.memo, name: @storage.name, parent_id: @storage.parent_id, type_id: @storage.type_id } }
    end
  ...
  test "should update storage" do
    patch storage_url(@storage), params: { storage: { memo: @storage.memo, name: @storage.name, parent_id: @storage.parent_id, type_id: @storage.type_id } }
