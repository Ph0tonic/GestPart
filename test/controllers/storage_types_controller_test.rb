...
class StorageTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create storage_type" do
    assert_difference('StorageType.count') do
      post storage_types_url, params: { storage_type: { description: @storage_type.description, icon: @storage_type.icon, name: @storage_type.name } }
    end
  ...
  test "should update storage_type" do
    patch storage_type_url(@storage_type), params: { storage_type: { description: @storage_type.description, icon: @storage_type.icon, name: @storage_type.name } }
