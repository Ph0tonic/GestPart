...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post pieces_url, params: { piece: { distribution: @piece.distribution, divers: @piece.divers, edition: @piece.edition, no: @piece.no, title: @piece.title } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { distribution: @piece.distribution, divers: @piece.divers, edition: @piece.edition, no: @piece.no, title: @piece.title } }
